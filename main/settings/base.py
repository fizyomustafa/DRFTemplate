...
#LOGGER yani basılan hataları falan tutan yerin kodu, buradan aşağıyı kopyala al Debugları bir yere toplamak istiyorsan.
...
LOGGING = {
    ...
    "handlers": {
        ...
        'file': {
            ...
            "formatter": "verbose",
            'filename': './debug.log',
            'level': 'INFO', #buraya hani seviyede hataları istiyorsak onları yazabiliriz. WARNING, ERROR, CRITICAL, INFO, DEBUG olabilir.
        },
    },
